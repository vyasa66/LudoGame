...
def leftclick_redroll(event):
    ...
    # roll()
    label1 = Label(
        root, text=str(x), relief=RAISED, padx=20, pady=20, fg="red", bd=10
    )
    label1.config(font=("Courier", 60))
    label1.grid(row=0, column=0)


button_redroll = Button(
    frame2,
    text="ROLL",
    height=2,
    width=6,
    ...
    for i in range(15):
        for j in range(15):
            ...
            if (i) in (0, 1, 2, 3, 4, 5):
                if j == 0:
                    canvas.create_rectangle(
                        x1, y1, x2, y2, fill="red", outline="red"
                    )
            if (i) in (0, 1, 2, 3, 4, 5):
                if j == 5:
                    canvas.create_rectangle(
            ...
            if (i) == 2:
                if j == 2:
                    canvas.create_oval(
                        x1 - goti_place_offset,
                        y1 - goti_place_offset,
                        x2 - goti_place_offset,
                        y2 - goti_place_offset,
                        fill="white",
                        outline="white",
                    )
            if (i) == 4:
            ...
            if (i) in (9, 10, 11, 12, 13, 14):
                if j == 9:
                    canvas.create_rectangle(
                        x1, y1, x2, y2, fill="yellow", outline="yellow"
                    )
            if (i) in (9, 10, 11, 12, 13, 14):
                if j == 14:
                    canvas.create_rectangle(
            ...
            if (i) in (0, 1, 2, 3, 4, 5):
                if j == 9:
                    canvas.create_rectangle(
                        x1, y1, x2, y2, fill="blue", outline="blue"
                    )
            if (i) in (0, 1, 2, 3, 4, 5):
                if j == 14:
                    canvas.create_rectangle(
            ...
            canvas.create_polygon(
                240, 360, 300, 300, 360, 360, fill="blue", outline="black"
            )
            canvas.create_polygon(
                360, 360, 300, 300, 360, 240, fill="yellow", outline="black"
            )
            canvas.create_polygon(
                360, 240, 300, 300, 240, 240, fill="green", outline="black"
            )
            canvas.create_polygon(
                240, 240, 300, 300, 240, 360, fill="red", outline="black"
            )
...
yellow_1_x = 420
yellow_1_y = 445
yellow_1 = canvas.create_polygon(
    yellow_1_x,
    yellow_1_y,
    yellow_1_x + goti_size,
    yellow_1_y - goti_size,
    yellow_1_x + goti_size,
    yellow_1_y + goti_size,
    fill="yellow",
    outline="black",
...
yellow_2_x = 420 + 80
yellow_2_y = 445
yellow_2 = canvas.create_polygon(
    yellow_2_x,
    yellow_2_y,
    yellow_2_x + goti_size,
    yellow_2_y - goti_size,
    yellow_2_x + goti_size,
    yellow_2_y + goti_size,
    fill="yellow",
    outline="black",
...
yellow_3_x = 420
yellow_3_y = 445 + 80
yellow_3 = canvas.create_polygon(
    yellow_3_x,
    yellow_3_y,
    yellow_3_x + goti_size,
    yellow_3_y - goti_size,
    yellow_3_x + goti_size,
    yellow_3_y + goti_size,
    fill="yellow",
    outline="black",
...
yellow_4_x = 420 + 80
yellow_4_y = 445 + 80
yellow_4 = canvas.create_polygon(
    yellow_4_x,
    yellow_4_y,
    yellow_4_x + goti_size,
    yellow_4_y - goti_size,
    yellow_4_x + goti_size,
    yellow_4_y + goti_size,
    fill="yellow",
    outline="black",
        ...
        if r1.x == 6:
            ...
            if r1.position == 0:
                canvas.coords(
                    ...
                    r1.xcord1,
                    r1.ycord1,
                    r1.xcord1 + goti_size * 0.25,
                    r1.ycord1 - goti_size * 0.25,
                    r1.xcord1 + goti_size * 0.25,
                    r1.ycord1 + goti_size * 0.25,
                )
        ...
        if r2.x == 6:
            ...
            if r2.position == 0:
                canvas.coords(
                    ...
                    r2.xcord1,
                    r2.ycord1,
                    r2.xcord1 + goti_size * 0.25,
                    r2.ycord1 - goti_size * 0.25,
                    r2.xcord1 + goti_size * 0.25,
                    r2.ycord1 + goti_size * 0.25,
                )
        ...
        if r3.x == 6:
            ...
            if r3.position == 0:
                canvas.coords(
                    ...
                    r3.xcord1,
                    r3.ycord1,
                    r3.xcord1 + goti_size * 0.25,
                    r3.ycord1 - goti_size * 0.25,
                    r3.xcord1 + goti_size * 0.25,
                    r3.ycord1 + goti_size * 0.25,
                )
        ...
        if r4.x == 6:
            ...
            if r4.position == 0:
                canvas.coords(
                    ...
                    r4.xcord1,
                    r4.ycord1,
                    r4.xcord1 + goti_size * 0.25,
                    r4.ycord1 - goti_size * 0.25,
                    r4.xcord1 + goti_size * 0.25,
                    r4.ycord1 + goti_size * 0.25,
                )
        ...
        if b1.x == 6:
            ...
            if b1.position == 0:
                canvas.coords(
                    ...
                    b1.xcord1,
                    b1.ycord1,
                    b1.xcord1 + goti_size * 0.25,
                    b1.ycord1 - goti_size * 0.25,
                    b1.xcord1 + goti_size * 0.25,
                    b1.ycord1 + goti_size * 0.25,
                )
        ...
        if b2.x == 6:
            ...
            if b2.position == 0:
                canvas.coords(
                    ...
                    b2.xcord1,
                    b2.ycord1,
                    b2.xcord1 + goti_size * 0.25,
                    b2.ycord1 - goti_size * 0.25,
                    b2.xcord1 + goti_size * 0.25,
                    b2.ycord1 + goti_size * 0.25,
                )
        ...
        if b3.x == 6:
            ...
            if b3.position == 0:
                canvas.coords(
                    ...
                    b3.xcord1,
                    b3.ycord1,
                    b3.xcord1 + goti_size * 0.25,
                    b3.ycord1 - goti_size * 0.25,
                    b3.xcord1 + goti_size * 0.25,
                    b3.ycord1 + goti_size * 0.25,
                )
        ...
        if b4.x == 6:
            ...
            if b4.position == 0:
                canvas.coords(
                    ...
                    b4.xcord1,
                    b4.ycord1,
                    b4.xcord1 + goti_size * 0.25,
                    b4.ycord1 - goti_size * 0.25,
                    b4.xcord1 + goti_size * 0.25,
                    b4.ycord1 + goti_size * 0.25,
                )
        ...
        if y1.x == 6:
            ...
            if y1.position == 0:
                canvas.coords(
                    ...
                    y1.xcord1,
                    y1.ycord1,
                    y1.xcord1 + goti_size * 0.25,
                    y1.ycord1 - goti_size * 0.25,
                    y1.xcord1 + goti_size * 0.25,
                    y1.ycord1 + goti_size * 0.25,
                )
        ...
        if y2.x == 6:
            ...
            if y2.position == 0:
                canvas.coords(
                    ...
                    y2.xcord1,
                    y2.ycord1,
                    y2.xcord1 + goti_size * 0.25,
                    y2.ycord1 - goti_size * 0.25,
                    y2.xcord1 + goti_size * 0.25,
                    y2.ycord1 + goti_size * 0.25,
                )
        ...
        if y3.x == 6:
            ...
            if y3.position == 0:
                canvas.coords(
                    ...
                    y3.xcord1,
                    y3.ycord1,
                    y3.xcord1 + goti_size * 0.25,
                    y3.ycord1 - goti_size * 0.25,
                    y3.xcord1 + goti_size * 0.25,
                    y3.ycord1 + goti_size * 0.25,
                )
        ...
        if y4.x == 6:
            ...
            if y4.position == 0:
                canvas.coords(
                    ...
                    y4.xcord1,
                    y4.ycord1,
                    y4.xcord1 + goti_size * 0.25,
                    y4.ycord1 - goti_size * 0.25,
                    y4.xcord1 + goti_size * 0.25,
                    y4.ycord1 + goti_size * 0.25,
                )
        ...
        if g1.x == 6:
            ...
            if g1.position == 0:
                canvas.coords(
                    ...
                    g1.xcord1,
                    g1.ycord1,
                    g1.xcord1 + goti_size * 0.25,
                    g1.ycord1 - goti_size * 0.25,
                    g1.xcord1 + goti_size * 0.25,
                    g1.ycord1 + goti_size * 0.25,
                )
        ...
        if g2.x == 6:
            ...
            if g2.position == 0:
                canvas.coords(
                    ...
                    g2.xcord1,
                    g2.ycord1,
                    g2.xcord1 + goti_size * 0.25,
                    g2.ycord1 - goti_size * 0.25,
                    g2.xcord1 + goti_size * 0.25,
                    g2.ycord1 + goti_size * 0.25,
                )
        ...
        if g3.x == 6:
            ...
            if g3.position == 0:
                canvas.coords(
                    ...
                    g3.xcord1,
                    g3.ycord1,
                    g3.xcord1 + goti_size * 0.25,
                    g3.ycord1 - goti_size * 0.25,
                    g3.xcord1 + goti_size * 0.25,
                    g3.ycord1 + goti_size * 0.25,
                )
        ...
        if g4.x == 6:
            ...
            if g4.position == 0:
                canvas.coords(
                    ...
                    g4.xcord1,
                    g4.ycord1,
                    g4.xcord1 + goti_size * 0.25,
                    g4.ycord1 - goti_size * 0.25,
                    g4.xcord1 + goti_size * 0.25,
                    g4.ycord1 + goti_size * 0.25,
                )
